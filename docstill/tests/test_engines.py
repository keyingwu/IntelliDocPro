...
from docstill.document import Document
from docstill.engines import available_engines, get_engine
from docstill.engines.azure_openai import AzureOpenAIExtractor
from docstill.engines.claude import ClaudeExtractor
from docstill.engines.openai import OpenAIExtractor
from docstill.engines.openai_common import document_part
from docstill.errors import DocumentTooLarge, EngineNotConfigured, UnknownEngine
from docstill.prompts import (
    EXTRACTION_SYSTEM,
    LLMExtractionOut,
    LLMFieldOut,
    LLMRefinedField,
...
def test_default_models(monkeypatch):
    monkeypatch.setenv("DOCSTILL_OPENAI_MODEL", "gpt-5.6-sol")
