...
import docstill.compare as compare_module
from docstill.compare import Candidate, compare_engines
from docstill.errors import DocstillError, EngineError
from docstill.result import ExtractionResult
...
def test_default_candidates_require_configured_engine(monkeypatch):
    ...
    with pytest.raises(DocstillError, match="no candidates"):
